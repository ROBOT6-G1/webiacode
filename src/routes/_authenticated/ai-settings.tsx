...
export const AI_PROVIDERS: Array<{
  ...
  },
  {
    ...
    url: "https://console.anyscale.com/credentials",
  ...
  },
  {
    id: "octoai",
    label: "OctoAI",
    url: "https://octoai.cloud/settings/tokens",
  ...
  },
  {
    id: "reka",
    label: "Reka AI",
    url: "https://platform.reka.ai/apikeys",
    model: "reka-core",
    free: true,
  },
  {
    id: "aleph",
    label: "Aleph Alpha",
    url: "https://app.aleph-alpha.com/profile",
  ...
  },
  {
    id: "friendli",
    label: "Friendli AI",
    url: "https://suite.friendli.ai/personal-settings/tokens",
    model: "meta-llama-3.1-70b-instruct",
    free: true,
  },
  {
  ...
  },
  {
    id: "kluster",
    label: "Kluster.ai",
    url: "https://platform.kluster.ai/apikeys",
...
function AiSettings() {
  ...
  const subExpires = (q.data?.profile as { ai_sub_expires_at?: string | null } | null | undefined)
    ?.ai_sub_expires_at;
  ...
  const save = async () => {
    ...
    try {
      ...
      await setDoc(
        ref,
        { ...prev, user_id: user.uid, ai_provider: provider, ai_api_key: apiKey.trim() },
        { merge: true },
      );
    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Utilisez votre propre clé API IA (30+ fournisseurs). Vous ne consommez plus de crédits
          DEVWEBIA — un simple abonnement mensuel de <strong>10 000 Ar / mois</strong> suffit.
        </p>
      </div>

      <div
        className={`rounded-2xl border p-5 ${subActive ? "border-primary/40 bg-primary/5" : "border-amber-500/40 bg-amber-500/5"}`}
      >
      ...
      <p className="text-xs text-muted-foreground">
        Astuce : la plupart des fournisseurs marqués <em>free tier</em> offrent un quota gratuit
        permanent. DEVWEBIA détecte automatiquement le meilleur modèle disponible chez votre
        fournisseur.
      </p>
    </div>
  );
